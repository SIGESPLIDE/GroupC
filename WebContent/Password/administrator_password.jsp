	...
	<div class="container mt-5 flex-grow-1 overflow-y-auto">
		...
		<div
			...
			<div class="password-card shadow-sm">
				<div class="password-card-header">管理者パスワード変更</div>
				<div class="password-card-body">
					...
					<form
						action="${pageContext.request.contextPath}/password/administrator_password"
						method="post">
						<input type="password" id="newPassInput" name="newPassword"
							class="form-control mx-auto custom-input" maxlength="10"
							placeholder="新しいパスワードを入力(10字以内)" required>
						<div>
							<button type="button" id="changeBtn" class="btn btn-submit-red"
