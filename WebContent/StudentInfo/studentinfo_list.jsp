							...
							<form action="${pageContext.request.contextPath}/studentinfo/studentinfo_list" method="post">
								<div class="row g-3 align-items-end">
									<div class="col-md-4">
										...
										<input type="text" name="searchId" class="form-control border-secondary-subtle"
											placeholder="IDを入力" value="${not empty searchId ? searchId : ''}">
									</div>
									<div class="col-md-5">
										<label class="form-label small fw-bold text-secondary">生徒名</label>
										<input type="text" name="searchName" class="form-control border-secondary-subtle"
											placeholder="名前を入力" value="${not empty searchName ? searchName : ''}">
									</div>
									<div class="d-flex flex-column col-md-3">
										<button type="button" class="btn btn-primary w-100 shadow-sm mb-1"
											onclick="location.href='${pageContext.request.contextPath}/studentinfo/studentinfo_regist'">
											<i class="bi bi-person-plus-fill"></i> 新規登録
										</button>
