...
<div
	...
	<div class="container-fluid mt-5 flex-grow-1 overflow-y-auto mb-3">
		...
		<%-- 入力欄 --%>
		<form
			action="${pageContext.request.contextPath}/studentinfo/studentinfo_regist"
			method="post">
			<div
				class="container form-group form-control form-control-lg d-flex flex-column w-50">
				<label>生徒ID</label><input type="text" id="idInput" name="studentId"
					value="${studentId}" placeholder="生徒IDを入力してください" required>
				<label>年</label><input type="text" id="gradeInput" value="${grade}"
					name="grade" maxlength="4" placeholder="年を入力してください(4字以内)" required>
				<label>組</label><input type="text" id="claInput" value="${cla}"
					name="cla" maxlength="4" placeholder="組を入力してください(4字以内)" required>
				<label>名前</label><input type="text" id="nameInput"
					name="studentName" value="${studentName}" maxlength="25"
		...
		<div
			...
			<button type="button" class="btn btn-primary shadow-sm"
				style="width: 7rem;" id="preRegisterCheck">
				登録</button>
