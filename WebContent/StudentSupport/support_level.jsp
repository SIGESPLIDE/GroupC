        ...
        <div class="container w-75 pb-5">
                ...
                <div class="d-flex gap-3">
                    ...
                    <form action="${pageContext.request.contextPath}/studentsupport/support_level_update" method="post">
                        ...
                        <button type="button" class="btn btn-primary shadow-sm" style="width: 10rem;"
                            data-bs-toggle="modal" data-bs-target="#supportupConfirmModal">
                            支援段階を上げる
                        </button>
                    </form>
                </div>
            ...
            <c:choose>
                ...
                <c:when test="${empty attReco || attReco.totalDays == 0}">
                    <div class="text-center text-primary py-5"><h4>昨日までの登校記録はありません</h4></div>
                </c:when>
                <%-- ログインログアウト情報がある場合 --%>
                <c:otherwise>
                    <table class="table table-striped text-center border-secondary w-100 shadow-sm">
                        <tbody>
                            <tr><td class="py-4"><h5>連続登校日数 : ${attReco.sequentialDays} 日</h5></td></tr>
                            <tr><td class="py-4"><h5>学校滞在時間 : ${attReco.schoolTime} 時間</h5></td></tr>
