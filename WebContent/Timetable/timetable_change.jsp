	...
	<div class="content-area d-flex flex-column h-100 position-relative">
							...
							<tr>
								...
								<c:forEach var="wd" items="${weekdayList}">
									<td class="align-middle"><input type="text"
										name="subject_${wd}_${i}" value="${timetableMap[wd][i]}"
										class="form-control form-control-sm mx-auto"
										style="width: 90%;" maxlength="10"></td>
								</c:forEach>
							</tr>
						</c:forEach>
					</tbody>
		...
		<div
			...
			<button type="button" class="btn btn-secondary shadow-sm"
				style="width: 7rem;" onclick="submitBack();">戻る</button>

			<button type="button" class="btn btn-primary shadow-sm"
				style="width: 7rem;" data-bs-toggle="modal"
				data-bs-target="#updateConfirmModal">変更</button>
		</div>
	</div>
</form>
