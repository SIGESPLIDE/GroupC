...
<div class="modal fade" id="deleteConfirmModal" tabindex="-1" aria-labelledby="registerConfirmModalLabel" aria-hidden="true">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (confirmButton) {
            confirmButton.addEventListener('click', function() {
                ...
                var completedUrl = '<%= request.getContextPath() %>/ModalCompletion/delete_completed.jsp';
